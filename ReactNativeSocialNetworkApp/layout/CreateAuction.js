...
const CreateAuction = ({ navigation }) => {
    ...
    const Create_auction = async () => {
        try {
            ...
            if (validateInputs(content, productName, price, description)) {
                ...
                if (validateDates(startDate, endDate, payDate)) {
                    ...
                    let res = await AuthApis(token).post(endpoints['Create_auction'], formData, {
                        headers: {
    ...
    return (
        ...
        <View style={styles.container}>
            <TouchableOpacity style={styles.view_button_post} onPress={() => Create_auction()}>
                <Text style={styles.buton_post} >Đăng Bài</Text>
            </TouchableOpacity>
            <ScrollView>
                <View>
                ...
                <View>
                    ...
                    <View style={styles.inputView}>
                        ...
                        <Text style={styles.text_birthday} onPress={() => setShowDatePicker(true)}>{endDate.toDateString()}</Text>
